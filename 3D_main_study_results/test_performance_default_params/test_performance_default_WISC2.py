...
model_WXGB = XGBClassifier(booster = 'gbtree', n_estimators = 200, max_depth = 2, min_child_weight = 1, scale_pos_weight = xgb_weight, random_state = seed1, early_stopping_rounds = 10)
