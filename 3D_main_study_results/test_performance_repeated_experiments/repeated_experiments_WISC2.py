...
ROS_params1 = dict(sampling_strategy = 0.9)
SMOTE_params1 = dict(sampling_strategy = 1.0, k_neighbors = 3)
ADASYN_params1 = dict(sampling_strategy = 0.8, n_neighbors = 5)
RUS_params1 = dict(sampling_strategy = 1.0)

ROS_params2 = dict(sampling_strategy = 1.0)
SMOTE_params2 = dict(sampling_strategy = 0.9, k_neighbors = 4)
ADASYN_params2 = dict(sampling_strategy = 1.0, n_neighbors = 4)
RUS_params2 = dict(sampling_strategy = 1.0)
