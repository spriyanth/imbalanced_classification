...
ROS_params1 = dict(sampling_strategy = 0.5)
SMOTE_params1 = dict(sampling_strategy = 0.4, k_neighbors = 6)
ADASYN_params1 = dict(sampling_strategy = 0.3, n_neighbors = 6)
RUS_params1 = dict(sampling_strategy = 0.5)

ROS_params2 = dict(sampling_strategy = 0.6)
SMOTE_params2 = dict(sampling_strategy = 0.4, k_neighbors = 5)
ADASYN_params2 = dict(sampling_strategy = 0.3, n_neighbors = 5)
