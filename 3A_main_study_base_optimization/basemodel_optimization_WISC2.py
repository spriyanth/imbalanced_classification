...
# use default settings for a more conservative and generalized setup => BAcc = 0.939, F2-Score = 0.913
...
# base performance: BAcc = 0.937, F2-Score = 0.916
...
# post-optimization performance: bacc = 0.938, F2-Score = 0.918 => marginal improvement in recall and thus F2-Score.